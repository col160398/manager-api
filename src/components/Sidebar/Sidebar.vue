<template>
    ...
    <div class="w-64 absolute sm:relative bg-gray-800 shadow md:h-screen flex-col justify-between hidden sm:flex">
        <div class="px-8">
            <div class="h-16 w-full flex items-center">
                <div class="flex items-center md:justify-start w-14 md:w-64 h-14 dark:bg-gray-800 border-none text-gray-300">
                    <img class="w-7 h-7 md:w-10 md:h-10 mr-2 rounded-md overflow-hidden" src="../../assets/avatarAmNote.png" />
                    <span class="hidden md:block">{{isNameAccount}}</span>
                </div>
            </div>
            <ul class="mt-12">
            ...
            <div class="flex justify-center mt-48 mb-4 w-full">
                <div class="relative">
                    ...
                    <input class="bg-gray-700 focus:outline-none rounded w-full text-lg text-gray-500 pl-10 py-2" type="text" placeholder="Search" />
                </div>
            </div>
        </div>
