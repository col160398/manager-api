<template>
    <!-- Response Mobile -->
    <div class="w-64 h-full z-40 absolute bg-gray-800 shadow md:h-screen flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
        ...
        <div class="px-8 py-2">
            <div class="h-16 w-full flex items-center">
                <div class="flex items-center md:justify-start w-18 md:w-80 h-14 dark:bg-gray-800 border-none text-gray-300">
                    <img class="w-1/2 h-7 md:w-10 md:h-10 mr-2 rounded-md overflow-hidden" src="https://therminic2018.eu/wp-content/uploads/2018/07/dummy-avatar.jpg" />
                    <span class="w-full">{{isNameAccount}}</span>
                </div>
            </div>
            <ul class="mt-12">
                <li class="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                    <div class="flex items-center">
                        ...
                        <router-link :to="{name:'Home'}" ><span class="text-lg ml-2">Khách hàng</span></router-link> 
                    </div>
                    <div class="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">{{countCustomers}}</div>
                </li>
                <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                    <div class="flex items-center">
                        ...
                        <span class="text-lg ml-2">Danh mục 2</span>
                    </div>
                </li>
                <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                    <div class="flex items-center">
                        ...
                        <span class="text-lg ml-2">Danh mục 3</span>
                    </div>
                </li>
                <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                    <div class="flex items-center">
                        ...
                        <span class="text-lg ml-2">Danh mục 4</span>
                    </div>
                </li>
                <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                    <div class="flex items-center">
                        ...
                        <span class="text-lg ml-2">Danh mục 5</span>
                    </div>
                </li>
                <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                    <div class="flex items-center">
                        ...
                        <span class="text-lg ml-2">Danh mục 6</span>
                    </div>
                </li>
                <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                    <div class="flex items-center">
                        ...
                        <span class="text-lg ml-2">Danh mục 7</span>
                    </div>
                </li>
                <li @click="logoutAccount()" class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"/>
                            <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
                        </svg>
                        <span class="text-lg ml-2">Đăng xuất</span>
                    </div>
                </li>
            </ul>
            <div class="flex justify-center py-12 w-full bg-gray-800 h-full" > 
                <div class="relative">
        ...
        <div class="px-8 border-t border-gray-700 bg-gray-800">
...
export default {
    ...
    computed:{
        ...mapGetters("auth",["isNameAccount"]),
        ...mapGetters("customers",["countCustomers"]),
    },
    data() {
        return {
            moved: true,
